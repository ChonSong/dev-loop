# Cron Job: agent-os: Docker Container Health Monitor (FAILED)

**Job ID:** ef11d87bb1d6
**Run Time:** 2026-05-03 21:54:27
**Schedule:** 0 8,20 * * *
...
```
TimeoutError: Cron job 'agent-os: Docker Container Health Monitor' idle for 11616s (limit 600s) — last activity: API error recovery (attempt 1/3)
```
