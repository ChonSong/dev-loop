...
```
RuntimeError: Error code: 400 - {'error': {'message': 'Model not exist.', 'id': 'be52c632-ef09-4403-8e39-e204469983f2', 'type': 'invalid_request_error', 'code': 'model_not_found'}}
```
