...
```
RuntimeError: Error code: 400 - {'error': {'message': 'Model not exist.', 'id': '09f9b642-ad2b-4ea9-80aa-9f4cf8bc2220', 'type': 'invalid_request_error', 'code': 'model_not_found'}}
```
