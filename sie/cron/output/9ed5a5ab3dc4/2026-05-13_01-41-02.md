...
```
RuntimeError: Error code: 400 - {'error': {'message': 'Model not exist.', 'id': '87e9894d-92b4-4158-a679-a26f5174fb83', 'type': 'invalid_request_error', 'code': 'model_not_found'}}
```
