...
```
RuntimeError: Error code: 400 - {'error': {'message': 'Model not exist.', 'id': 'f3127eb2-7893-4520-86f9-8e3b3955c91b', 'type': 'invalid_request_error', 'code': 'model_not_found'}}
```
