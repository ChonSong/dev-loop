...
A reference file documents essay-specific patterns found in real academic writing tasks. Load it with `skill_view(name="humanizer", file_path="references/essay-ai-tells.md")`.
