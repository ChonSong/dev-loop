#!/usr/bin/env python3
"""
humanize.py — strip AI tells from text. Data-driven rules from 278K human/AI pairs.
Usage:
  python3 scripts/humanize.py < input.txt > output.txt
  python3 scripts/humanize.py --aggressive < input.txt
"""
...
def vary_sentence_lengths(text: str) -> str:
    """Create burstiness — sentence-length variance matching human data (CV ~0.85)."""
...
def add_imperfections(text: str) -> str:
    # Start some mid-text sentences with conjunctions (~7% of starts)
