...
## Preconditions for writing a post-mortem

After landing a fix, offer to write a post-mortem if all four are true:
- [ ] **Reliable repro** exists (not "happens sometimes")
...
If all four are true: "Want a post-mortem? I can hand this to `post-mortem` to write the canonical record."